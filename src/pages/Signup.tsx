...
const Signup = () => {
  ...
  const overlayBg =
    "bg-gradient-to-r from-blue-800 via-[#3B49CF] to-indigo-800";

  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-[#fff] shadow-md">
      <div className="h-4/5 w-4/5 bg-white shadow-md relative overflow-hidden rounded-lg">
        ...
        <div
          ...
          className={`absolute hidden md:block top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-700 ease-in-out z-100 ${
