...
const Layout = () => {
  return (
    <div className="overflow-x-hidden">
      <nav className="py-5 lg:fixed transition-all bg-opacity-90  backdrop:blur-md shadow-md top-0 left-0 z-50 duration-500 w-full bg-white">
          ...
          <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
            <div className="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-indigo-600 to-violet-600 rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
              <a href="/" className="flex justify-center lg:justify-start">
                <img
                  className="w-40 h-8"
                  src="https://res.cloudinary.com/djowwwlua/image/upload/v1721220225/White_Logo_4x_yy3zxg.png"
                />
              </a>
